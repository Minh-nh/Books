...
import AdminBorrowedTicketDetail from './components/admin/borrowed_ticket_management/borrowed_ticket_detail';
...
const routes = [
    ...
    {
        path: '/admin/borrowed_ticket/:id',
        exact: false,
        main: ({ match }) => <AdminBorrowedTicketDetail match={match} />
    },
];
